...
import { modifyItem} from '../actions/index';
    ...
    render() {
        ...
        return (
            <div>
                    ...
                    <button onClick={this.props.modifyItem.bind(this, this.state.newItem)}> save</button>
                    <Link to ="/" >back</Link>
...
function matchDispatchToProps(dispatch) {
    return bindActionCreators({ modifyItem: modifyItem }, dispatch);
}
